...
export const messages = {
  en: {
    ...
    yachtOnline: {
      ...
      waitingRoomDesc: "After the second player joins, both players press READY to begin.",
      readyToPlay: "READY",
      readyPanelTitle: "Match Ready",
      readyPanelDesc: "Both players press READY to start the match.",
      readyOn: "READY",
      readyOff: "WAIT",
      playerScore: "PLAYER SCORE",
  ...
  ko: {
    ...
    yachtOnline: {
      ...
      roomReady: "준비 완료",
      waitingRoom: "대기실",
      waitingRoomDesc: "두 번째 플레이어가 참가한 뒤, 양쪽이 게임 준비를 누르면 시작됩니다.",
      readyToPlay: "게임 준비",
      readyPanelTitle: "게임 준비",
      readyPanelDesc: "두 플레이어가 모두 게임 준비를 누르면 시작됩니다.",
      readyOn: "준비 완료",
      readyOff: "대기",
      playerScore: "플레이어 점수",
      rivalScore: "상대 점수",
